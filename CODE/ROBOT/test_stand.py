...
LOG_FILE = "/home/pi/DATN/distance_log.csv"
log_start_time = time.time()
log_lock = threading.Lock()

def init_distance_log():
...
def log_distance(left, right, decision, cmd):
    try:
...
def auto_loop():
    ...
    while running:
        ...
        log_distance(left, right, decision, current_cmd)
        time.sleep(0.08)
